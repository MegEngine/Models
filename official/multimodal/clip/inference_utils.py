...
class ClipInferenceUtils():

    @staticmethod
    def generate_imagenet_templates():
        imagenet_templates = [
            'a bad photo of a {}.',
            'a photo of many {}.',
            'a sculpture of a {}.',
    ...
    def generate_imagenet_classes():
        imagenet_classes = [
            ...
            "house finch", "junco", "indigo bunting", "American robin", "bulbul", "jay", "magpie",
            "chickadee", "American dipper", "kite (bird of prey)", "bald eagle", "vulture",
            ...
            "Shetland Sheepdog", "collie", "Border Collie", "Bouvier des Flandres dog",
            "Rottweiler", "German Shepherd Dog", "Dobermann", "Miniature Pinscher",
            ...
            "Miniature Poodle", "Standard Poodle", "Mexican hairless dog (xoloitzcuintli)",
            "grey wolf", "Alaskan tundra wolf", "red wolf or maned wolf", "coyote", "dingo",
            "dhole", "African wild dog", "hyena", "red fox", "kit fox", "Arctic fox", "grey fox",
            "tabby cat", "tiger cat", "Persian cat", "Siamese cat", "Egyptian Mau", "cougar",
            ...
            "fox squirrel", "marmot", "beaver", "guinea pig", "common sorrel horse", "zebra",
            "pig", "wild boar", "warthog", "hippopotamus", "ox", "water buffalo", "bison",
            "ram (adult male sheep)", "bighorn sheep", "Alpine ibex", "hartebeest",
            "impala (antelope)", "gazelle", "arabian camel", "llama", "weasel", "mink",
            ...
            "ambulance", "amphibious vehicle", "analog clock", "apiary", "apron", "trash can",
            "assault rifle", "backpack", "bakery", "balance beam", "balloon", "ballpoint pen",
            "Band-Aid", "banjo", "baluster / handrail", "barbell", "barber chair", "barbershop",
            "barn", "barometer", "barrel", "wheelbarrow", "baseball", "basketball", "bassinet",
            "bassoon", "swimming cap", "bath towel", "bathtub", "station wagon", "lighthouse",
            "beaker", "military hat (bearskin or shako)", "beer bottle", "beer glass",
            "bell tower", "baby bib", "tandem bicycle", "bikini", "ring binder", "binoculars",
            "birdhouse", "boathouse", "bobsleigh", "bolo tie", "poke bonnet", "bookcase",
            ...
            "chain", "chain-link fence", "chain mail", "chainsaw", "storage chest", "chiffonier",
            "bell or wind chime", "china cabinet", "Christmas stocking", "church", "movie theater",
            ...
            "grand piano", "greenhouse", "radiator grille", "grocery store", "guillotine",
            ...
            "rickshaw", "joystick", "kimono", "knee pad", "knot", "lab coat", "ladle", "lampshade",
            ...
            "messenger bag", "mailbox", "tights", "one-piece bathing suit", "manhole cover",
            ...
            "obelisk", "oboe", "ocarina", "odometer", "oil filter", "pipe organ", "oscilloscope",
            "overskirt", "bullock cart", "oxygen mask", "product packet / packaging", "paddle",
            "paddle wheel", "padlock", "paintbrush", "pajamas", "palace", "pan flute",
            "paper towel", "parachute", "parallel bars", "park bench", "parking meter",
            "railroad car", "patio", "payphone", "pedestal", "pencil case", "pencil sharpener",
            "perfume", "Petri dish", "photocopier", "plectrum", "Pickelhaube", "picket fence",
            ...
            "hockey puck", "punching bag", "purse", "quill", "quilt", "race car", "racket",
            ...
            "schooner", "scoreboard", "CRT monitor", "screw", "screwdriver", "seat belt",
            ...
            "balaclava ski mask", "sleeping bag", "slide rule", "sliding door", "slot machine",
            ...
            "vase", "vaulted or arched ceiling", "velvet fabric", "vending machine", "vestment",
            "viaduct", "violin", "volleyball", "waffle iron", "wall clock", "wallet", "wardrobe",
            ...
            "espresso", "tea cup", "eggnog", "mountain", "bubble", "cliff", "coral reef",
            ...
            "coral fungus", "agaric", "gyromitra", "stinkhorn mushroom", "earth star fungus",
            "hen of the woods mushroom", "bolete", "corn cob", "toilet paper"
        ]
        return imagenet_classes

    @staticmethod
    def generate_zeroshot_classifier_weight(
        model: CLIP,
        classnames: List[str],
        templates: List[str]
    ):
        ...
        for classname in tqdm(classnames):
            ...
            class_embeddings /= F.norm(class_embeddings, axis=-1, keepdims=True)
            class_embedding = F.mean(class_embeddings, axis=0)
            class_embedding /= F.norm(F.flatten(class_embedding))
            zeroshot_weights.append(class_embedding)
        zeroshot_weights = F.stack(zeroshot_weights, axis=1)
    ...
    def predict(
        ...
        for images, target in tqdm(loader):
            ...
            image_features /= F.norm(image_features, axis=-1, keepdims=True)
            logits = logit_scale * (image_features @ zeroshot_weights)

            acc1, acc5 = ClipInferenceUtils.accuracy(logits, target, topk=(1, 5))
            top1 += acc1
            top5 += acc5
            n += images.shape[0]
